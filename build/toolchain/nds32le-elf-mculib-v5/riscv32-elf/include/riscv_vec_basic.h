...
/**
 * @brief Vector absolute function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src pointer of the input vector
 * @param[in] count number of elements to be processed
...
#if defined (__riscv_zfh)
/**
 * @brief Vector addition function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
...
#if defined (__riscv_zfh)
/**
 * @brief Vector Add constant function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src pointer of the input vector
 * @param[in] cst constant value with data type of float16_t
 * @param[in] count number of elements to be processed.
 * @return Return RISCV_VEC_OK only
 *
 * @b Note:
 ...
 * This function is only supported by the toolchain with the HW FPU support. Also, you need to apply option “-mzfh” both in compiling flags and linking flags for applications that use this function. For details about the linking option“-mzfh”.
 */
int riscv_vec_addc_f16(float16_t* dst, float16_t* src, const float16_t cst, uint32_t count);
#endif
...
#if defined (__riscv_zfh)
/**
 * @brief Vector multiplication function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
...
#if defined (__riscv_zfh)
/**
 * @brief Vector multipy constant function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src pointer of the input vector
 * @param[in] cst constant value with data type of float16_t
...
#if defined (__riscv_zfh)
/**
 * @brief Vector set constant function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] cst constant value with data type of float16_t
 * @param[in] count number of elements to be processed
...
#if defined (__riscv_zfh)
/**
 * @brief Vector subtraction function for f16
 *
 * @param[out] dst pointer of the output vector
 * @param[in] src1 pointer of the first input vector
 * @param[in] src2 pointer of the second input vector
