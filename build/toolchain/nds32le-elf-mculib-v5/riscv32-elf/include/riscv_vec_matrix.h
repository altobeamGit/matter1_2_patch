 ...
 * @b Note
 *
 * This function is only supported by the toolchain with the HW FPU support. Also, you need
 * to apply the linking option "-mzfh" for applications that use this function. For details
 * about the linking option "-mzfh" , please refer to Linking option Section
 */
int riscv_vec_rmmat_mul_f16(float16_t * src1, float16_t * src2, float16_t * dst, uint32_t row, uint32_t col, uint32_t col2);
#endif
