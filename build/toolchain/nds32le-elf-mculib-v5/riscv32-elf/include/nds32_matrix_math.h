...
#define nds32_mat_add_f32 riscv_dsp_mat_add_f32

/// Addition of two q15 matrices.
#define nds32_mat_add_q15 riscv_dsp_mat_add_q15

/// Addition of two q31 matrices.
#define nds32_mat_add_q31 riscv_dsp_mat_add_q31

// Matrix Inverse
//
/// Compute the inverse matrix of the floating-potint matrix.
#define nds32_mat_inv_f32 riscv_dsp_mat_inv_f32
#define nds32_mat_inv_f64 riscv_dsp_mat_inv_f64

// Matrix Multiplication
//
/// Multiplication of two floating-point matrices.
#define nds32_mat_mul_f32 riscv_dsp_mat_mul_f32
#define nds32_mat_mul_f64 riscv_dsp_mat_mul_f64

/// Multiplication of two q15 matrices.
#define nds32_mat_mul_q15 riscv_dsp_mat_mul_q15

/// Multiplication of two q31 matrices.
#define nds32_mat_mul_q31 riscv_dsp_mat_mul_q31

// Matrix Power 2 Function
//
/// Matrix Power 2 Function
#define nds32_mat_pwr2_cache_f64 riscv_dsp_mat_pwr2_cache_f64
#define nds32_mat_pow2_cache_f64 riscv_dsp_mat_pwr2_cache_f64

// Matrix Scale
//
/// Multiplt a scale value of floating-potint matrix.
#define nds32_mat_scale_f32 riscv_dsp_mat_scale_f32

/// Multiplt a scale value of q15 matrix.
#define nds32_mat_scale_q15 riscv_dsp_mat_scale_q15

/// Multiplt a scale value of q31 matrix.
#define nds32_mat_scale_q31 riscv_dsp_mat_scale_q31

// Matrix Subtraction
//
/// Substraction of two floating-potint matrices.
#define nds32_mat_sub_f32 riscv_dsp_mat_sub_f32

/// Substraction of two q15 matrices.
#define nds32_mat_sub_q15 riscv_dsp_mat_sub_q15

/// Substraction of two q31 matrices.
#define nds32_mat_sub_q31 riscv_dsp_mat_sub_q31

// Matrix Transpose
//
/// Transpose the floating-potint matricex.
#define nds32_mat_trans_f32 riscv_dsp_mat_trans_f32

/// Transpose the q15 matricex.
#define nds32_mat_trans_q15 riscv_dsp_mat_trans_q15

/// Transpose the q31 matricex.
#define nds32_mat_trans_q31 riscv_dsp_mat_trans_q31

///  Transpose the u8 matricex.
#define nds32_mat_trans_u8 riscv_dsp_mat_trans_u8
