...
class ATBMSecureCertDACProvider : public Credentials::DeviceAttestationCredentialsProvider
{
public:
    ATBMSecureCertDACProvider() : Credentials::DeviceAttestationCredentialsProvider() {}
    ~ATBMSecureCertDACProvider() {}
