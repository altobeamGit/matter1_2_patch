...
#define portDISABLE_INTERRUPTS()	//do{ GIE_SAVE( (unsigned int *)&psw_1);} while(0)
#define portENABLE_INTERRUPTS()		//do{ GIE_RESTORE(psw_1);} while(0)

void vPortEnterCritical();
void vPortExitCritical();
void vPortEnterCritical_Internal();
void vPortExitCritical_Internal();

#define portENTER_CRITICAL()     	vPortEnterCritical_Internal()
#define portEXIT_CRITICAL()     	vPortExitCritical_Internal()
