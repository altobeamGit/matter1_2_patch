...
/**
 * Concrete implementation of the BLEManager singleton object for the ATBM platform.
 */
...
private:
    ...
    enum class Flags : uint16_t
    {
        ...
        kATBMBLELayerInitialized   = 0x0002, /**< The ATBM BLE layer has been initialized. */
    ...
    CHIP_ERROR InitATBMBleLayer(void);
